# TURUBA Technologies — Phase 1 Website

Static company landing page for turubatechnologies.com.
...
5. Connect `turubatechnologies.com` through the host's domain settings/DNS.
